...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference("Mission.count") do
      post missions_url, params: { mission: { initiated: @mission.initiated, name: @mission.name, terminated: @mission.terminated } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { initiated: @mission.initiated, name: @mission.name, terminated: @mission.terminated } }
